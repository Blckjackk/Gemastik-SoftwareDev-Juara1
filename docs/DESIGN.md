...
colors:
  # === WARNA PRIMER (Identitas LabSim - Diubah ke Tech-Teal yang lebih edukatif & scientific) ===
  primary: "#00838F"          # Cyan-Teal yang cerdas, hidup, dan memicu rasa ingin tahu
  primary-focus: "#006064"    # Versi lebih gelap saat tombol di-hover/klik
  primary-on-dark: "#4DD0E1"  # Cyan terang agar tetap kontras di atas background gelap
  on-primary: "#ffffff"

  # === TIPOGRAFI & TEKS (Diubah dari hitam pekat ke Slate-Charcoal agar mata tidak cepat lelah) ===
  ink: "#1E252B"              # Hitam dengan sedikit tint biru tua/slate (nyaman untuk membaca instruksi)
  body: "#1E252B"             # Teks utama
  body-on-dark: "#ffffff"     # Teks di atas background gelap
  body-muted: "#94A3B8"       # Teks sekunder (misal: keterangan rumus/satuan)
  ink-muted-80: "#334155"     # Teks sub-heading
  ink-muted-48: "#64748B"     # Teks penjelasan/placeholder

  # === STRUKTUR UI & GARIS (Tetap bersih dan minimalis) ===
  divider-soft: "#F1F5F9"     # Pembatas antar section laporan
  hairline: "#E2E8F0"         # Garis tepi panel kontrol simulasi
  canvas: "#ffffff"           # Latar belakang utama (putih bersih)
  canvas-parchment: "#F8FAFC" # Latar belakang area kerja/lab (sedikit keabu-abuan agar alat lab terlihat menonjol)
  surface-pearl: "#F1F5F9"    # Latar belakang kartu/widget asesmen guru
  surface-chip-translucent: "rgba(0, 131, 143, 0.08)" # Chip transparan berbasis warna primary

  # === SURFACE DARK MODE / PANEL SIMULASI (Dibuat seperti warna meja lab digital modern) ===
  surface-tile-1: "#1E293B"   # Panel instrumen utama (misal: osiloskop, tabung reaksi)
  surface-tile-2: "#334155"   # Dropdown atau pop-up di dalam simulasi
  surface-tile-3: "#0F172A"   # Latar belakang gelap total untuk eksperimen cahaya/laser
  surface-black: "#020617"
  on-dark: "#ffffff"

  # === INTEGRASI TAMBAHAN: AKSEN MODUL SAINS (Sangat krusial untuk filter/kategori kurikulum) ===
  sains-fisika: "#2563EB"     # Royal Blue (Merepresentasikan energi, listrik, gaya)
  sains-kimia: "#7C3AED"      # Deep Violet (Merepresentasikan reaksi, larutan, transformasi)
  sains-biologi: "#16A34A"    # Organic Green (Merepresentasikan alam, sel, ekosistem)
  
  # === INDIKATOR ASESMEN GURU & FEEDBACK SISWA ===
  feedback-success: "#22C55E" # Langkah eksperimen benar / Nilai tuntas
  feedback-warning: "#EAB308" # Peringatan: Zat kimia hampir overload / Butuh remedial
  feedback-error: "#EF4444"   # Eksperimen gagal / Konsleting listrik (Grafik drop)
